...
" <Leader>ad - Compile and deplay the current sketch
...
" This ensures the feature is toggled on each time we load vim
...
" Sets the color order for the parentheses (bottom to top)
let g:rbpt_colorpairs = [
    \ ['red',       'RoyalBlue3'],
    \ ['Darkblue',    'SeaGreen3'],
    \ ['darkgreen',    'DarkOrchid3'],
    \ ['brown',     'DarkOrchid3'],
    \ ['lightmagenta',   'firebrick3'],
    \ ['darkcyan',    'RoyalBlue3'],
    \ ['darkred',     'SeaGreen3'],
